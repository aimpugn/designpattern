package pattern.i_iterator.book.main;

import pattern.i_iterator.book.Book;
import pattern.i_iterator.book.BookShelf;
...
public class Main {
	 ...
	 * 왜 반복자를 사용할까?
	 * <p>
	 * `구현`{@link pattern.i_iterator.book.BookShelf}에 의존하지 않고 반복 가능하기 때문
	 * <p>
	 * 즉, 아래 코드의 변경 없이, {@link pattern.i_iterator.book.BookShelf} 수정하고 iterator만 정상적으로 반환하면 동작함
	 * <p>
	 * 이로 인해 클래스, {@link pattern.i_iterator.book.BookShelf}의 재이용성이 높아진다
	 * <p>
